...
public class CameraSupport : MonoBehaviour
{
    ...
    void Start(){
        ...
        p = transform.localPosition;
         // obtain timmy's position
        timmiyPos = GameObject.Find("Timmy").transform.localPosition;
        transform.position = timmiyPos;
    ...
    void Update()
    {
        ...
        if(Camera.main.orthographicSize < cameraSize){
            ...
            transform.position = Vector3.Lerp(transform.position, p, Time.fixedDeltaTime * zoomOutSpeed);
        }
    }
